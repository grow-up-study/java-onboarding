...
public class Problem7 {
    ...
    public static List<String> result (String user, List<List<String>> friends, List<String> visitors) {
            ...
            for (List<String> friendPair : friends) {                                   // friend를 하나씩 넣어봄
            ...
            Map<String, Integer> scoreMap = new HashMap<>();                             // 사용자가 아는 모든 사용자와 친구가 아닌 사용자들의 추천 점수를 계산
            ...
            for (String visitor : visitors) {                                            // 사용자 타임라인을 방문한 기록이 있는 경우 추천 점수를 추가
